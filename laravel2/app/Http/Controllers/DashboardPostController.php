...
class DashboardPostController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($request->file('image')) {
            $validatedData['image'] = $request->file('image')->store('post-pictures');
        }
    ...
    public function update(Request $request, Post $post)
    {
        ...
        return redirect('dashboard/postingan')->with('success', 'Post telah di update');
        }
        else
    ...
    public function destroy(Post $post)
    {
        ...
        if(auth()->user()->username == 'admin123') {
        return redirect('dashboard/postingan')->with('success', 'Post telah dihapus');
        }
        else
